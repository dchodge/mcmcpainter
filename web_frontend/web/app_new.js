class MCMCPainterApp {
    ...
    toggleDropdown(type) {
        const dropdown = type === 'image' ? this.imageDropdown : this.configDropdown;
        const btn = type === 'image' ? this.imageDropdownBtn : this.configDropdownBtn;
    ...
    handleImageSelection(e) {
        ...
        switch (action) {
            ...
            case 'upload':
                ...
                break;
            case 'dragdrop':
                this.showMessage('Drag and drop an image file anywhere on the page', 'success');
    ...
    async processFile(file) {
        try {
            ...
            this.currentImageName.textContent = file.name;
    ...
    async useDefaultImage(imageName = 'lotus') {
        try {
            ...
            this.processImage(img);
            this.currentImageName.textContent = imageNames[imageName];
            this.imagePreviewContainer.style.display = 'block';
